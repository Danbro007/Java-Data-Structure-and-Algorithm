...
public class KruskalCase {
     ...
     * A------>B-------->C------>D，我们要查找顶点A的终点，我们先找到A的终点B，然后再找V的终点C,最后找到C的终点D，既ends[3] = 0
     ...
     *          startPos = 4 ----> 4 的终点为 4 , E，既它自身
     *          endPos = 5 -----> 5 的终点为 5，F，既它自身
     *          startPos的终点设置为 endPos的终点
     *          ends[4] = 5
     *          ends = {0,0,0,0,5,0,0,0,0,0,0,0,0}
     *第二次:
     *          ends = {0,0,0,0,5,0,0,0,0,0,0,0,0}
     *          startPos = 2 ----> 2 的终点为 2，C，既它自身
     *          endPos = 3 -----> 3 的终点为 3，D，既它自身
     *          startPos的终点设置为 endPos的终点
     *          ends[2] = 3
     *          ends = {0,0,3,0,5,0,0,0,0,0,0,0,0}
     *第三次:
     *          ends = {0,0,3,0,5,0,0,0,0,0,0,0,0}
     *          startPos = 3 ----> 3 的终点为 3，D，既它自身
     *          endPos = 4 -----> 4 的终点为 5  E，！= 0----->i = 5 ---->ends[5] = 0 终点为 5
     *          startPos的终点设置为 endPos 的终点
     *          ends[3] = 5
     *          ends = {0,0,3,5,5,0,0,0,0,0,0,0,0}
     *第四次:
     *          ends = {0,0,3,5,5,0,0,0,0,0,0,0,0}
     *          startPos = 2 ----> 2 的终点为 C  ends[2] = 3 != 0----->  i = 3,ends[3] = 5 != 0 ---->i = 5,ends[5] = 0---->终点为 5
     *          endPos = 4 -----> 4 的终点为 5 ,E
     *          由于 2 和 4 的终点相同 ----->形成回路
     *          ends = {0,0,3,5,5,0,0,0,0,0,0,0,0}
     *第五次:
     *          ends = {0,0,3,5,5,0,0,0,0,0,0,0,0} C、F
